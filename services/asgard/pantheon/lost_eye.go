...
// Huginn: логично, чтобы инверсию делал я, а не пустой глаз. TODO программист, подумай.
// Huginn: Пустой глаз видит одну картинку - прямую энтропию, а обратная - это уже математические операции над ней.
// Odin: я не согласен, это запутает код. Пока не будем трогать.
