...
// RememberSeed
// Odin: я вижу прошлое и будущее, и знаю, какая картина будет нарисована следующая.
// Odin: сейчас я напрягу свой глаз, а вороны Хугин и Мунин подскажут мне номер картины, который определит
// Odin: финальный вариант самого изображения. StableDiffusion знает, как с этим номером нарисовать конкретную картинку
