...
<template>
  <div class="p-6">
    ...
    <div class="notification is-danger is-light">
      ...
      <br/>
      <b>Asgard-сервер временно отключен из-за антироссийских санкций</b> - нет доступа к одному из важных ресурсов. <br/>
      Работа artchitect будет возобновлена после снятия антироссийских санкций.
    </div>
